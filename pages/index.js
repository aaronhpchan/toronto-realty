  ...
  return (
    <Box>
      <Flex justifyContent='center' position='relative' height={{ base: '300', md: '450', lg: '600' }}>
        <Image src='/banner.webp' alt='banner' width={2000} height={1200} objectFit='cover' />
        <Box position='absolute' top='12.5%'>
          <Text fontSize={{ base: '3xl', sm: '4xl', md: '5xl', lg: '6xl' }} fontWeight='semibold' color='gray.600'>Welcome Home</Text>
        </Box>
      </Flex>
      <Banner 
        purpose='Buy a Home'
